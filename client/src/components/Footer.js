            ...
            <div className="footerContainer">
                ...
                <div className="socialLogoContainer">
                    <ul className="socialLogos">
                        <li>
                            <a rel="external" href="https://www.linkedin.com/in/abhishek-verma-05177625b" target="_blank">
                        ...
                        <li>
                            <a rel="external" href="https://github.com/AbhishekX2004" target="_blank">
                        ...
                        <li style={{paddingLeft:"5px"}}>
                            <a rel="external" href="https://www.instagram.com/xx_abhishek_verma_xx" target="_blank">
